...
class CFA(nn.Module):
    def __init__(self, depth=[3, 4, 8, 3], in_chans=64, num_classes=1000, embed_dim=[64, 128, 320, 512],
...
model_urls = {
    "CFA_tiny_in1k": "https://matix.li/e36fe9fb086c",
    "CFA_small_in1k": "https://matix.li/5bb436318902",
    "CFA_base_in1k": "https://matix.li/995db75f585d",
}
...
@register_model
def CFA_tiny(pretrained=False, pretrained_cfg=None,
...
@register_model
def CFA_small(pretrained=False, pretrained_cfg=None,
                   pretrained_cfg_overlay=None, **kwargs):
    model = CFA(
        depth=[4, 4, 18, 4],
        embed_dim=[64, 128, 256, 512], mlp_ratios=[3, 3, 3, 3],
...
@register_model
def CFA_base(pretrained=False, pretrained_cfg=None,
                  pretrained_cfg_overlay=None, **kwargs):
    model = CFA(
        depth=[4, 4, 18, 4],
